const WhyChooseUs = () => {
  ...
  //               Green Agriculture đã thay đổi cách chúng tôi tiêu thụ thực phẩm.
  //               Sản phẩm luôn tươi ngon, chất lượng vượt mong đợi và dịch vụ chăm

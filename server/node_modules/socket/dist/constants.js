...
const LAZY_ENV = () => {
  ...
  return Object.freeze({
    ...
    INLINED_SOCKET_CLI_VERSION: envAsString("1.0.76"),
    // Comp-time inlined Socket package version hash.
    // The '@rollup/plugin-replace' will replace "process.env['INLINED_SOCKET_CLI_VERSION_HASH']".
    INLINED_SOCKET_CLI_VERSION_HASH: envAsString("1.0.76:088fc0e:f44ef2f8:pub"),
...
//# debugId=38a95d4e-7638-47b8-a7ff-f82bea98bafe

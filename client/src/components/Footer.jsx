...
const Footer = () => {
  return (
    <div>
      <footer className=" flex flex-col relative w-full mb-0">
        <div className="bg-gray-200 px-5 md:px-40 flex flex-col sm:flex-row mx-auto  w-full gap-8 py-12 justify-between ">
          {/* <!-- Column: Company --> */}
          <ul>
        ...
        <div className=" bg-gray-300 flex w-full flex-col items-center justify-center gap-4 border-t border-stone-200 py-4 md:flex-row md:justify-around">

...
async function shadowBin(binName, args = process.argv.slice(2)) {
  ...
  constants.SUPPORTS_NODE_PERMISSION_FLAG ? ['--permission', '--allow-child-process',
  // '--allow-addons',
  // '--allow-wasi',
  // Allow all reads because npm walks up directories looking for config
  // and package.json files.
  '--allow-fs-read=*', `--allow-fs-write=${process.cwd()}/*`,
...
//# debugId=b1b4c149-143a-43ce-a5e7-f442095a8c7a
